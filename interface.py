...
if "group" not in st.session_state:
    ...
    try:
        ...
        st.error(f"Failed to assign condition: {e}")
        st.stop()
...
<div style="background-color:#f8f9fa;padding:20px;border-radius:10px;border-left:5px solid #007bff;">
  ...
  <p style="font-size:16px;line-height:1.6;">
    <strong>What you'll do:</strong> Review AI responses to clinical cases and provide your professional assessment (10‑15 minutes)
  </p>
...
# ————— Diagnostic Information Collection —————
    ...
    if age and profession:
        if st.button("Continue to Study", type="primary"):
            ...
            try:
                db.update_participant_info(st.session_state.participant_id, age, profession)
